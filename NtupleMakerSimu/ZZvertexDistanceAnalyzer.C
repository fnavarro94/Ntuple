#define ZZvertexDistanceAnalyzer_cxx
// The class definition in ZZvertexDistanceAnalyzer.h has been generated automatically
...
//
// Root > T->Process("ZZvertexDistanceAnalyzer.C")
// Root > T->Process("ZZvertexDistanceAnalyzer.C","some options")
// Root > T->Process("ZZvertexDistanceAnalyzer.C+")
//

#include "ZZvertexDistanceAnalyzer.h"
#include <TH2.h>
#include <TStyle.h>


void ZZvertexDistanceAnalyzer::Begin(TTree * /*tree*/)
{
...
void ZZvertexDistanceAnalyzer::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t ZZvertexDistanceAnalyzer::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either ZZvertexDistanceAnalyzer::GetEntry() or TBranch::GetEntry()
...
{   double p1[3], p2[3], pV[3], sv1[3], sv2[3], dot, dotL;
   ...
   // finished filling inv mass hists
...
double ZZvertexDistanceAnalyzer::dotP(double pV[3], double sv1[3], double sv2[3], double p1[3], double p2[3])
{
...
double ZZvertexDistanceAnalyzer::dotPLW(double pV[3], double sv1[3], double sv2[3], double p1[3], double p2[3])
{
	double VAv[3], vertV[3], pTot[3], dot;
...
double ZZvertexDistanceAnalyzer::norm(double x, double y, double  z)
{
	return sqrt(x*x+y*y+z*z);
}

double ZZvertexDistanceAnalyzer::norm(double x, double y)
{
	return sqrt(x*x+y*y);
}

void ZZvertexDistanceAnalyzer::reset()
{
...
double ZZvertexDistanceAnalyzer::invMass(double px1, double py1, double pz1, double px2 , double py2,  double pz2)
{
...
double ZZvertexDistanceAnalyzer::deltaV(double vx1, double vy1, double vz1, double vx2, double vy2, double vz2)
{
   double dx = vx1-vx2;
   double dy = vy1-vy2;
   double dz = vz1 - vz2;
...
void ZZvertexDistanceAnalyzer::SlaveTerminate()
{
...
void ZZvertexDistanceAnalyzer::Terminate()
{
