...
std::string toFind[2] = {"HLT_DoublePhoton33_v", "HLT_DoublePhoton33_HEVT", "HLT_DoublePhoton38_HEVT", "HLT_DoublePhoton3", "HLT_DoublePhoton4"};
...
/*
 ...
 HLT_DoublePhoton43_HEVT_v2
  250 HLT_DoublePhoton48_HEVT_v2
  251 HLT_DoublePhoton70_v2
  252 HLT_DoublePhoton80_v3*/
